...
<%@page import="java.model.Newsletter"%>
<%@page import="java.get.NewsletterGet"%>
<%@page import="java.model.Contact"%>
<%@page import="java.get.ContactGet"%>
<%@page import="java.model.UserAdmin"%>
<%@page import="java.model.User"%>
<%@page import="java.get.UserGet"%>
<%@page import="java.util.ArrayList"%>
<%@page import="java.model.Category"%>
<%@page import="java.get.CategoryGet"%>
